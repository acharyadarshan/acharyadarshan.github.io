...
summary: Automated composition of abc notation using char RNN that can be played by using inbuilt music library or external library
tags: [LSTM, python, charRNN, abc notation, Scraping]
author: Darshan Acharya
---

Demo
{% include iframe_holder.html url="https://youtube.com/embed/NDuJbYVpBW0" width="560" height="315" padding-bottom = "6.25%"  %}
